...
void check_up_collision_30fps(mainchar_t *c)
{
    int check = c->move.y - 5;
...
void check_right_collision_30fps(mainchar_t *c)
{
    int check = c->move.x + 5;
...
void check_left_collision_30fps(mainchar_t *c)
{
    int check = c->move.x - 5;
